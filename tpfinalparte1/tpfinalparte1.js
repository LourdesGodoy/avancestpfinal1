...
function mousePressed() {
  ...
  if (estado == 4) { //esta desicion puede llevarte a la pantalla 5 o 7
    if (clickEnBoton(200, 410, 90, 30)) estado = 5;
    if (clickEnBoton(400, 410, 90, 30)) estado = 7;
  }
  if (estado == 8) { //esta desicion puede llevarte a la pantalla 9 o 10
    if (clickEnBoton(200, 410, 90, 30)) estado = 9;
    if (clickEnBoton(400, 410, 90, 30)) estado = 10;
  }
  if (estado == 11) { //esta desicion puede llevarte a la pantalla 12 o 13
    if (clickEnBoton(200, 410, 90, 30)) estado = 12;
    if (clickEnBoton(400, 410, 90, 30)) estado = 13;
  }
  if (estado == 15) { //esta desicion puede llevarte a la pantalla 16 o 17
    if (clickEnBoton(200, 410, 90, 30)) estado = 16;
    if (clickEnBoton(400, 410, 90, 30)) estado = 17;
  }

  //TODOS LOS POSIBLES FINALES
  if ((estado == 10 || estado == 12 || estado === 18 || estado === 19) && clickEnBoton(200, 410, 90, 30)) {
    reiniciarPrograma();
  }
}
